...
class CarousselWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    CarouselSliderController carouselSlideController = CarouselSliderController();
    Timer? timer;

    nextSlide(){
      carouselSlideController!.nextPage(
          duration: Duration(milliseconds: 300), curve: Curves.linear);
      print("############ dure slide ########");
      print(borneController.dureeDuSlide.value);
      print(borneController.slides.length);
    }
              ...
              CarouselSlider(
                ...
                options: CarouselOptions(
                  ...
                  onPageChanged: (index, reason) {
                    ...
                    //_startAutoSlide();
                    Timer(Duration(seconds: borneController.dureeDuSlide.value),nextSlide);
                  },
                ),
              ),
            ] else
